...
const RegisterUser = _i1.OperationDefinitionNode(
  ...
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'childname')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
        isNonNull: false,
      ),
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'childage')),
      type: _i1.NamedTypeNode(
    ...
    _i1.FieldNode(
      ...
      arguments: [
        ...
        _i1.ArgumentNode(
          ...
          value: _i1.VariableNode(name: _i1.NameNode(value: 'childname')),
        ),
        _i1.ArgumentNode(
          name: _i1.NameNode(value: 'childage'),
          value: _i1.VariableNode(name: _i1.NameNode(value: 'childage')),
        ),
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
